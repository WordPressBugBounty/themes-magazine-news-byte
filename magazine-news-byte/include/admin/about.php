		...
		<div id="hoot-about-sub" class="hoot-about-sub">
			...
			<div class="hoot-about-text">
				...
				<p class="hoot-about-textlinks">
					...
					<a class="button" href="https://wordpress.org/support/theme/magazine-news-byte/reviews/#new-post" target="_blank"><span class="dashicons dashicons-thumbs-up"></span> <?php esc_html_e( 'Rate Us', 'magazine-news-byte' ) ?></a>
				</p>
...
function magnb_upstrings( $string ) {
	...
	$features[] = array(
		...
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( '%1$s Premium allows you to create unlimited sliders with as many slides as you need using the awesome HootKit plugin.%2$sSelect from displaying your own images with text to carousels and vertical sliding lists for posts and WooCommerce products.', 'magazine-news-byte' ), $themename, '<hr>' ),
	...
	$quickstart[] = array(
		...
		/* Translators: The %s are placeholders for HTML, so the order can't be changed. */
		'desc' => sprintf( esc_html__( 'Importing demo content is the easiest way to setup your theme and make it look like the %1$sDemo Site%2$s', 'magazine-news-byte' ), '<a href="https://demo.wphoot.com/magazine-news-byte/" target="_blank">', '</a>' )
			. '<hr />' . $hootthemeimplink,
		);
