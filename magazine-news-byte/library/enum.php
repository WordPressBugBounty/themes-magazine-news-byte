...
function hoot_enum_social_profiles( $skype = false, $email = true ) {
	$social = array(
		'fa-airbnb'         => __( 'Air Bnb', 'magazine-news-byte' ),
		'fa-amazon'         => __( 'Amazon', 'magazine-news-byte' ),
		'fa-android'        => __( 'Android', 'magazine-news-byte' ),
		'fa-apple'          => __( 'Apple', 'magazine-news-byte' ),
		'fa-app-store'      => __( 'App Store', 'magazine-news-byte' ),
		'fa-app-store-ios'  => __( 'App Store ios', 'magazine-news-byte' ),
		'fa-audible'        => __( 'Audible', 'magazine-news-byte' ),
		...
		'fa-bluesky'        => __( 'Bluesky', 'magazine-news-byte' ),
		'fa-btc'            => __( 'BTC', 'magazine-news-byte' ),
		'fa-buysellads'     => __( 'BuySellAds', 'magazine-news-byte' ),
		'fa-cash-app'       => __( 'Cash App', 'magazine-news-byte' ),
		...
		'fa-discord'        => __( 'Discord', 'magazine-news-byte' ),
		...
		'fa-figma'          => __( 'Figma', 'magazine-news-byte' ),
		...
		'fa-kickstarter'    => __( 'Kickstarter', 'magazine-news-byte' ),
		...
		'fa-medium'         => __( 'Medium', 'magazine-news-byte' ),
		...
		'fa-shopify'        => __( 'Shopify', 'magazine-news-byte' ),
		...
		'fa-threads'        => __( 'Threads', 'magazine-news-byte' ),
		'fa-square-threads' => __( 'Threads Square', 'magazine-news-byte' ),
		...
		'fa-whatsapp'       => __( 'Whatsapp', 'magazine-news-byte' ),
		...
		'fa-x-twitter'      => __( 'X (Twitter)', 'magazine-news-byte' ),
		'fa-square-x-twitter' => __( 'X (Twitter) Square', 'magazine-news-byte' ),
